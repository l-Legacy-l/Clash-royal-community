<section>
    <p>
        <h2>Ajouter un deck</h2>
    <form action="../controleur/ajoutDeck.php" method="post">
    <table class = "profil">

    <tr>    
        <td>Nom du deck (facultatif):</td>
        <td><input type="text" name="nom" value="<?php if (isset($nom)) {echo $nom;} ?>"/></td>
    </tr>
    <tr>
        <td>Type :</td>
        <td><select name="type">
    ...
    <tr>    
        ...
        <td><input type="number" name="cout" step="0.1" required value="<?php if (isset($cout)) {echo $cout;} ?>" /></td>
    </tr>
    <tr>
        <td>Carte 1:</td>
        <td><select name="carte1" class="carte" onchange="disabledChamp();">
        ...
        <tr>
        <td>Carte 2:</td>
        <td><select name="carte2"  class="carte" onchange="disabledChamp();">
        <optgroup label= "Commune">
                <option></option>
        ...
        <tr>
        <td>Carte 3:</td>
        <td><select name="carte3"  class="carte" onchange="disabledChamp();">
        <optgroup label= "Commune">
                <option></option>
                <option name="Archers">Archers</option>
                <option name="Barbares">Barbares</option>
        ...
        <tr>
        <td>Carte 4:</td>
        <td><select name="carte4"  class="carte" onchange="disabledChamp();">
        <optgroup label= "Commune">
                <option></option>
                <option name="Archers">Archers</option>
                <option name="Barbares">Barbares</option>
    ...
    <tr>
    <td>Carte 5:</td>
    <td><select name="carte5"  class="carte" onchange="disabledChamp();">
    <optgroup label= "Commune">
                <option></option>
                <option name="Archers">Archers</option>
                <option name="Barbares">Barbares</option>
        ...
        <tr>
    <td>Carte 6:</td>
    <td><select name="carte6"  class="carte" onchange="disabledChamp();">
    <optgroup label= "Commune">
                <option></option>
                <option name="Archers">Archers</option>
                <option name="Barbares">Barbares</option>
        ...
        <tr>
    <td>Carte 7:</td>
    <td><select name="carte7"  class="carte" onchange="disabledChamp();">
    <optgroup label= "Commune">
                <option></option>
                <option name="Archers">Archers</option>
                <option name="Barbares">Barbares</option>
            ...
            <tr>
    <td>Carte 8:</td>
    <td><select name="carte8"  class="carte" onchange="disabledChamp();">
    <optgroup label= "Commune">
                <option></option>
                <option name="Archers">Archers</option>
                <option name="Barbares">Barbares</option>
       ...
       <td><textarea cols="40" rows="5" name="description"><?php if (isset($description)) {echo $description;} ?></textarea></td>
        </tr>
    <tr>
